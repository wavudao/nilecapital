    ...
    <article className="p-article-box">
      <Container article>
        ...
        <p>
          ...
          of Nile Capital and www.bigleaguefinance.com site, products and services ('Nile Capital” or the 'Service'); Nile Capital provides financial
        ...
        <p>
          ...
          email messages, you may opt out by sending an email message to admin@Nile Capital with the word 'UNSUBSCRIBE' in the subject field.
        </p>
      </Container>
    </article>
  );
